...
"[project]/src/components/Warmup.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Warmup() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Warmup.useEffect": ()=>{
            ({
                "Warmup.useEffect": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getServerStatus();
                        // eslint-disable-next-line no-console
...
_s(Warmup, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = Warmup;
var _c;
__turbopack_context__.k.register(_c, "Warmup");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_c028eb2d._.js.map